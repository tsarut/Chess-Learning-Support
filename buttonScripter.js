...
function swapImage(x) {
	...
	else if(x=='8'){document.getElementById("tester").style.backgroundImage="url(../../gui/posttest2.png)";}
	else {return;}
}
...
function swapImgRestore(x) {
	...
	else if(x=='8'){document.getElementById("tester").style.backgroundImage="url(../../gui/posttest.png)";}
	else {return;}
}